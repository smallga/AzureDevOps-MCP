...
async function main() {
  try {
    ...
    const artifactManagementTools = new ArtifactManagementTools(
      azureDevOpsConfig
    );
    const aiAssistedDevelopmentTools = new AIAssistedDevelopmentTools(
      azureDevOpsConfig
    );
    ...
    //   },
    //   async (params, extra) => {
    //     const result = await workItemTools.listWorkItems({
    //       query: params.query,
    //     });
    //     return {
    ...
    //       .number()
    //       .optional()
    //       .describe('Maximum number of work items to return'),
    //   },
    //   async (params, extra) => {
    ...
    //       .string()
    //       .optional()
    //       .describe('Description of the work item'),
    //     assignedTo: z
    //       .string()
    //       .optional()
    //       .describe('User to assign the work item to'),
    ...
    //       .string()
    //       .optional()
    //       .describe('Iteration path for the work item'),
    //     additionalFields: z
    //       .record(z.any())
    //       .optional()
    ...
    //       .string()
    //       .optional()
    //       .describe('Comment explaining the state change'),
    //   },
    //   async (params, extra) => {
    ...
    //       .string()
    //       .optional()
    //       .describe('Team ID (uses default team if not specified)'),
    //   },
    //   async (params, extra) => {
    ...
    //       .boolean()
    //       .optional()
    //       .describe('Include project capabilities'),
    //     includeHistory: z
    //       .boolean()
    //       .optional()
    //       .describe('Include project history'),
    //   },
    //   async (params, extra) => {
    ...
    //       .number()
    //       .optional()
    //       .describe('Maximum depth of the area hierarchy'),
    //   },
    //   async (params, extra) => {
    ...
    //       .boolean()
    //       .optional()
    //       .describe('Include deleted iterations'),
    //   },
    //   async (params, extra) => {
    ...
    //       .string()
    //       .optional()
    //       .describe('Path of the parent iteration'),
    //     startDate: z
    //       .string()
    //       .optional()
    //       .describe('Start date of the iteration'),
    ...
    //           .string()
    //           .optional()
    //           .describe('Version (branch, tag, or commit)'),
    ...
    server.tool(
      ...
      'List pull requests',
      {
        repositoryId: z.string().describe('ID of the repository'),
        status: z
          .enum(['abandoned', 'active', 'all', 'completed', 'notSet'])
          .optional()
    ...
    server.tool(
      ...
      'Create a new pull request',
      {
        ...
        isNeedAutoComplete: z
          .boolean()
          .optional()
          .describe('Auto complete the pull request'),
        isNeedDeleteSourceBranch: z
          .boolean()
          .optional()
    ...
    //       .number()
    //       .optional()
    //       .describe('ID of the test suite to run'),
    //     testPlanId: z
    //       .number()
    //       .optional()
    //       .describe('ID of the test plan to run'),
    //     testEnvironment: z
    //       .string()
    //       .optional()
    //       .describe('Environment to run tests in'),
    //     parallelExecution: z
    //       .boolean()
    //       .optional()
    ...
    //     testRunId: z
    //       .number()
    //       .describe('ID of the test run to check status for'),
    //   },
    //   async (params, extra) => {
    //     const result = await testingCapabilitiesTools.getTestAutomationStatus(
    //       params
    //     );
    //     return {
    //       content: result.content,
    ...
    //       .record(z.any())
    //       .optional()
    //       .describe('Capabilities to set for the agent'),
    //     enabled: z
    //       .boolean()
    //       .optional()
    ...
    //   },
    //   async (params, extra) => {
    //     const result = await testingCapabilitiesTools.configureTestAgents(
    //       params
    //     );
    //     return {
    //       content: result.content,
    ...
    //     dataSchema: z
    //       .record(z.any())
    //       .describe('Schema for the test data to generate'),
    //     recordCount: z
    //       .number()
    //       .optional()
    ...
    //   },
    //   async (params, extra) => {
    //     const result = await testingCapabilitiesTools.createTestDataGenerator(
    //       params
    //     );
    //     return {
    //       content: result.content,
    ...
    //       .record(z.any())
    //       .optional()
    //       .describe('Properties for the environment'),
    //   },
    //   async (params, extra) => {
    //     const result = await testingCapabilitiesTools.manageTestEnvironments(
    //       params
    //     );
    //     return {
    //       content: result.content,
    ...
    //       .number()
    //       .optional()
    //       .describe('ID of a specific test to analyze'),
    //     testRunIds: z
    //       .array(z.number())
    //       .optional()
    //       .describe('Specific test runs to analyze'),
    //     timeRange: z
    //       .string()
    //       .optional()
    //       .describe("Time range for analysis (e.g., '30d')"),
    //   },
    //   async (params, extra) => {
    ...
    //       .boolean()
    //       .optional()
    //       .describe('Only analyze recent code changes'),
    //   },
    //   async (params, extra) => {
    //     const result = await testingCapabilitiesTools.getTestGapAnalysis(
    //       params
    //     );
    //     return {
    //       content: result.content,
    ...
    //   },
    //   async (params, extra) => {
    //     const result = await testingCapabilitiesTools.runTestImpactAnalysis(
    //       params
    //     );
    //     return {
    //       content: result.content,
    ...
    //   },
    //   async (params, extra) => {
    //     const result = await testingCapabilitiesTools.getTestHealthDashboard(
    //       params
    //     );
    //     return {
    //       content: result.content,
    ...
    //     optimizationGoal: z
    //       .enum(['time', 'coverage', 'reliability'])
    //       .describe('Optimization goal'),
    //   },
    //   async (params, extra) => {
    //     const result = await testingCapabilitiesTools.runTestOptimization(
    //       params
    //     );
    //     return {
    //       content: result.content,
    ...
    //       .string()
    //       .optional()
    //       .describe('Description of the session'),
    //     areaPath: z.string().optional().describe('Area path for the session'),
    //   },
    //   async (params, extra) => {
    //     const result = await testingCapabilitiesTools.createExploratorySessions(
    //       params
    //     );
    //     return {
    //       content: result.content,
    ...
    //   async (params, extra) => {
    //     const result =
    //       await testingCapabilitiesTools.recordExploratoryTestResults(params);
    //     return {
    //       content: result.content,
    //       rawData: result.rawData,
    //       isError: result.isError,
    ...
    //   async (params, extra) => {
    //     const result =
    //       await testingCapabilitiesTools.convertFindingsToWorkItems(params);
    //     return {
    //       content: result.content,
    //       rawData: result.rawData,
    //       isError: result.isError,
    ...
    //   async (params, extra) => {
    //     const result =
    //       await testingCapabilitiesTools.getExploratoryTestStatistics(params);
    //     return {
    //       content: result.content,
    //       rawData: result.rawData,
    //       isError: result.isError,
    ...
    //     scanType: z
    //       .enum(['static', 'dynamic', 'container', 'dependency', 'all'])
    //       .optional()
    //       .describe('Type of security scan to run'),
    //   },
    //   async (params, extra) => {
    ...
    //       .string()
    //       .optional()
    //       .describe('ID of a specific vulnerability to track'),
    //     status: z
    //       .enum([
    //         'open',
    //         'in-progress',
    ...
    //       ])
    //       .optional()
    //       .describe('Filter by vulnerability status'),
    //     timeRange: z
    //       .string()
    //       .optional()
    ...
    //   },
    //   async (params, extra) => {
    //     const result = await devSecOpsTools.trackSecurityVulnerabilities(
    //       params
    //     );
    //     return {
    //       content: result.content,
    ...
    //   {
    //     standardType: z
    //       .enum(['owasp', 'pci-dss', 'hipaa', 'gdpr', 'iso27001', 'custom'])
    //       .optional()
    //       .describe('Compliance standard to report on'),
    //     includeEvidence: z
    //       .boolean()
    //       .optional()
    //       .describe('Include evidence in the report'),
    //   },
    //   async (params, extra) => {
    ...
    //       .boolean()
    //       .optional()
    //       .describe('Create work items from findings'),
    //   },
    //   async (params, extra) => {
    ...
    //       .string()
    //       .describe('Compliance standard to check against'),
    //     scopeId: z
    //       .string()
    //       .optional()
    //       .describe('Scope of the compliance check'),
    //   },
    //   async (params, extra) => {
    ...
    //       .string()
    //       .optional()
    //       .describe('ID of the compliance standard'),
    //     includeHistory: z
    //       .boolean()
    //       .optional()
    //       .describe('Include historical compliance data'),
    //   },
    //   async (params, extra) => {
    ...
    //       .record(z.any())
    //       .optional()
    //       .describe('Definition of the policy'),
    //   },
    //   async (params, extra) => {
    ...
    //       .string()
    //       .optional()
    //       .describe('ID of specific training to track'),
    //     timeRange: z
    //       .string()
    //       .optional()
    //       .describe("Time range for tracking (e.g., '90d')"),
    ...
    //       .string()
    //       .optional()
    //       .describe('Name of the secret to rotate'),
    //     secretType: z
    //       .enum(['password', 'token', 'certificate', 'key'])
    //       .optional()
    //       .describe('Type of secret to rotate'),
    //     force: z
    //       .boolean()
    //       .optional()
    //       .describe('Force rotation even if not expired'),
    //   },
    //   async (params, extra) => {
    ...
    //       .string()
    //       .optional()
    //       .describe('Name of the secret to audit'),
    //     timeRange: z
    //       .string()
    //       .optional()
    //       .describe("Time range for the audit (e.g., '30d')"),
    //   },
    //   async (params, extra) => {
    ...
    //       .string()
    //       .optional()
    //       .describe('Path to the secret in the vault'),
    //     action: z
    ...
    //   {
    //     feedType: z
    //       .enum(['npm', 'nuget', 'maven', 'python', 'universal', 'all'])
    //       .optional()
    //       .describe('Type of feeds to list'),
    //     includeDeleted: z
    //       .boolean()
    //       .optional()
    //       .describe('Include deleted feeds'),
    //   },
    //   async (params, extra) => {
    ...
    //     packageType: z
    //       .enum(['npm', 'nuget', 'maven', 'python', 'universal'])
    ...
    //       .boolean()
    //       .optional()
    //       .describe('Permanently delete the package version'),
    //   },
    //   async (params, extra) => {
    //     const result = await artifactManagementTools.deletePackageVersion(
    //       params
    //     );
    //     return {
    //       content: result.content,
    ...
    //       .string()
    //       .optional()
    //       .describe('Name of the container repository'),
    //     includeManifests: z
    //       .boolean()
    //       .optional()
    //       .describe('Include image manifests'),
    //     includeDeleted: z
    //       .boolean()
    //       .optional()
    //       .describe('Include deleted images'),
    //   },
    //   async (params, extra) => {
    //     const result = await artifactManagementTools.listContainerImages(
    //       params
    //     );
    //     return {
    //       content: result.content,
    ...
    //   },
    //   async (params, extra) => {
    //     const result = await artifactManagementTools.getContainerImageTags(
    //       params
    //     );
    //     return {
    //       content: result.content,
    ...
    //     scanType: z
    //       .enum(['vulnerability', 'compliance', 'both'])
    //       .optional()
    ...
    //     repositoryName: z.string().describe('Name of the container repository'),
    //     policyType: z
    //       .enum(['retention', 'security', 'access'])
    //       .describe('Type of policy to manage'),
    //     action: z
    //       .enum(['get', 'set', 'delete'])
    //       .describe('Action to perform on the policy'),
    //     policySettings: z
    //       .record(z.any())
    //       .optional()
    //       .describe('Settings for the policy when setting'),
    //   },
    //   async (params, extra) => {
    //     const result = await artifactManagementTools.manageContainerPolicies(
    //       params
    //     );
    //     return {
    //       content: result.content,
    ...
    //       .string()
    //       .optional()
    //       .describe('Path for package upload or download'),
    //     packageVersion: z
    //       .string()
    //       .optional()
    //       .describe('Version of the package'),
    //   },
    //   async (params, extra) => {
    //     const result = await artifactManagementTools.manageUniversalPackages(
    //       params
    //     );
    //     return {
    //       content: result.content,
    ...
    //       .string()
    //       .optional()
    //       .describe("Time range for the report (e.g., '30d')"),
    //     format: z
    //       .enum(['csv', 'json'])
    //       .optional()
    //       .describe('Format of the report'),
    ...
    //   async (params, extra) => {
    //     const result =
    //       await artifactManagementTools.createPackageDownloadReport(params);
    //     return {
    //       content: result.content,
    //       rawData: result.rawData,
    //       isError: result.isError,
    ...
    //       .boolean()
    //       .optional()
    //       .describe('Check for known vulnerabilities'),
    //   },
    //   async (params, extra) => {
    //     const result = await artifactManagementTools.checkPackageDependencies(
    //       params
    //     );
    //     return {
    //       content: result.content,
    ...
    //       .number()
    //       .optional()
    //       .describe('ID of the pull request to review'),
    //     repositoryId: z.string().optional().describe('ID of the repository'),
    ...
    //       .optional()
    //       .describe('Type of optimization to focus on'),
    //   },
    //   async (params, extra) => {
    //     const result = await aiAssistedDevelopmentTools.suggestCodeOptimization(
    //       params
    //     );
    //     return {
    //       content: result.content,
    ...
    //       .optional()
    //       .describe('Severity level to filter by'),
    //   },
    //   async (params, extra) => {
    //     const result = await aiAssistedDevelopmentTools.identifyCodeSmells(
    //       params
    //     );
    //     return {
    //       content: result.content,
    ...
    //   async (params, extra) => {
    //     const result =
    //       await aiAssistedDevelopmentTools.getPredictiveBugAnalysis(params);
    //     return {
    //       content: result.content,
    //       rawData: result.rawData,
    //     };
    ...
    //       .string()
    //       .optional()
    //       .describe("Time range for analysis (e.g., '30d', '3m')"),
    //     includeMetrics: z
    //       .array(z.string())
    //       .optional()
    ...
    //   async (params, extra) => {
    //     const result =
    //       await aiAssistedDevelopmentTools.getDeveloperProductivity(params);
    //     return {
    //       content: result.content,
    //       rawData: result.rawData,
    //     };
    ...
    //       .array(z.number())
    //       .optional()
    //       .describe('IDs of work items to estimate'),
    //     workItemType: z
    //       .string()
    //       .optional()
    //       .describe('Type of work items to estimate'),
    //     areaPath: z
    //       .string()
    //       .optional()
    //       .describe('Area path to filter work items'),
    //   },
    //   async (params, extra) => {
    //     const result =
    //       await aiAssistedDevelopmentTools.getPredictiveEffortEstimation(
    //         params
    //       );
    //     return {
    //       content: result.content,
    ...
    //       .string()
    //       .optional()
    //       .describe("Time range for analysis (e.g., '90d', '6m')"),
    //     metrics: z
    //       .array(z.string())
    //       .optional()
    //       .describe('Specific metrics to include'),
    //   },
    //   async (params, extra) => {
    //     const result = await aiAssistedDevelopmentTools.getCodeQualityTrends(
    //       params
    //     );
    //     return {
    //       content: result.content,
    ...
    //       .number()
    //       .optional()
    //       .describe('ID of the work item to refine'),
    ...
    //   async (params, extra) => {
    //     const result =
    //       await aiAssistedDevelopmentTools.suggestWorkItemRefinements(params);
    //     return {
    //       content: result.content,
    //       rawData: result.rawData,
    //     };
    ...
    //     projectId: z.string().optional().describe('ID of the project'),
    //     scopeType: z
    //       .enum(['builds', 'releases', 'tests', 'workitems', 'all'])
    //       .optional()
    //       .describe('Type of scope to analyze'),
    //   },
    //   async (params, extra) => {
    //     const result =
    //       await aiAssistedDevelopmentTools.suggestAutomationOpportunities(
    //         params
    //       );
    //     return {
    //       content: result.content,
    ...
    //     alertType: z
    //       .enum(['build', 'release', 'test', 'workitem', 'code'])
    //       .describe('Type of alert to create'),
    //     conditions: z.record(z.any()).describe('Conditions for the alert'),
    //     actions: z
    //       .record(z.any())
    //       .optional()
    //       .describe('Actions to take when the alert triggers'),
    //   },
    //   async (params, extra) => {
    //     const result = await aiAssistedDevelopmentTools.createIntelligentAlerts(
    //       params
    //     );
    //     return {
    //       content: result.content,
    ...
    //       .string()
    //       .optional()
    //       .describe("Period to analyze for patterns (e.g., '30d')"),
    //   },
    //   async (params, extra) => {
    //     const result = await aiAssistedDevelopmentTools.predictBuildFailures(
    //       params
    //     );
    //     return {
    //       content: result.content,
    ...
    //       .number()
    //       .optional()
    //       .describe('Maximum number of tests to select'),
    //   },
    //   async (params, extra) => {
    //     const result = await aiAssistedDevelopmentTools.optimizeTestSelection(
    //       params
    //     );
    //     return {
    //       content: result.content,
